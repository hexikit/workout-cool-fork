...
import { InteractiveProgramSessionClient } from "./InteractiveProgramSessionClient";
...
export async function generateMetadata({ params }: SessionDetailPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: sessionMetadata.title,
      description: sessionMetadata.description,
      url: `https://www.workout.cool/${locale}/programs/${slug}/interactive-session/${sessionSlug}`,
    ...
    alternates: {
      canonical: `https://www.workout.cool/${locale}/programs/${slug}/interactive-session/${sessionSlug}`,
      languages: {
        "fr-FR": `https://www.workout.cool/fr/programs/${slug}/interactive-session/${sessionSlug}`,
        "en-US": `https://www.workout.cool/en/programs/${slug}/interactive-session/${sessionSlug}`,
        "es-ES": `https://www.workout.cool/es/programs/${slug}/interactive-session/${sessionSlug}`,
        "pt-PT": `https://www.workout.cool/pt/programs/${slug}/interactive-session/${sessionSlug}`,
        "ru-RU": `https://www.workout.cool/ru/programs/${slug}/interactive-session/${sessionSlug}`,
        "zh-CN": `https://www.workout.cool/zh-CN/programs/${slug}/interactive-session/${sessionSlug}`,
        "x-default": `https://www.workout.cool/programs/${slug}/interactive-session/${sessionSlug}`,
      },
    },
    robots: {
      index: true,
...
export default async function SessionDetailPage({ params }: SessionDetailPageProps) {
  ...
  return (
    <>
      ...
      <InteractiveProgramSessionClient
