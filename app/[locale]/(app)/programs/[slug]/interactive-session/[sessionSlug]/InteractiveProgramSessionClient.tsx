...
import { InteractiveWorkout } from "@/features/workout-session/ui/interactive-workout";
...
interface InteractiveProgramSessionClientProps {
...
export function InteractiveProgramSessionClient({ program, week, session, isAuthenticated, isPremium }: InteractiveProgramSessionClientProps) {
  const t = useI18n();
  ...
  if (hasStartedWorkout && isWorkoutActive && workoutSession) {
    return (
      <div className="w-full max-w-6xl mx-auto">
        {/* The updated header will show interactive progress */}
        <WorkoutSessionHeader onQuitWorkout={handleQuitWorkout} />

        {/* The new interactive workout component */}
        <InteractiveWorkout />

        {/* The existing list view of all sets (optional, but good for overview) */}
        <div className="mt-8">
            <WorkoutSessionSets
                isWorkoutActive={isWorkoutActive}
                onCongrats={handleCompleteSession}
