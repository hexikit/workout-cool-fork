export default {
  ...
  admin: {
    dashboard: {
      ...
      workoutcool_admin: "WorkoutCool Admin",
    },
    users: {
      title: "Users",
      description: "Manage and administer user accounts",
      loading_error: "Could not load users",
      loading_error_heading: "Loading Error",
      loading_error_message: "Could not load the list of users. Please try again later.",
      unknown_error: "Unknown error",
    },
    programs: {
      title: "Programs",
      description: "Create, edit, view and delete programs.",
      loading: "Loading programs...",
      add_exercise_modal: {
        title: "Add an exercise",
        select_exercise_title: "Select an exercise",
        search_placeholder: "Search for an exercise...",
        select_button: "Select",
        change_button: "Change",
        instructions_title: "Instructions",
        instructions_fr_label: "Instructions (FR)",
        instructions_fr_placeholder: "Specific instructions for this exercise in this program...",
        instructions_en_label: "Instructions",
        instructions_en_placeholder: "Specific instructions for this exercise in this program...",
        suggested_sets_title: "Suggested Sets",
        strength_template: "Strength",
        bodyweight_template: "Bodyweight",
        timed_template: "Timed",
        add_set_button: "Add",
        set_type_label: "Type",
        select_option: "Select",
        weight_reps_option: "Weight + Reps",
        reps_only_option: "Reps only",
        time_option: "Time",
        bodyweight_option: "Bodyweight",
        weight_label: "Weight",
        ...
        validation: {
          ...
          instructions_fr_required: "Instructions are required",
          instructions_en_required: "English instructions are required"
        },
        add_exercise_error: "Error adding exercise",
        no_sets_configured: "No sets configured",
        add_first_set: "Add the first set",
        cancel: "Cancel",
        add_exercise: "Add exercise",
        adding_exercise: "Adding..."
      },
      add_session_modal: {
        title: "Add a session",
        add_session_error: "Error adding session",
        title_fr_label: "Title (French)",
        title_fr_placeholder: "Session {number}",
        description_fr_label: "Description (French)",
        description_fr_placeholder: "Description of this session...",
        title_en_label: "Title",
        title_en_placeholder: "Session {number}",
        description_en_label: "Description",
        description_en_placeholder: "Session description...",
        estimated_duration_label: "Estimated duration (minutes)",
        premium_session_label: "Premium session",
        required_equipment_label: "Required equipment",
        cancel: "Cancel",
        add_session: "Add session",
        adding_session: "Adding...",
        validation: {
          title_required: "Title is required",
          title_en_required: "English title is required",
          description_required: "Description is required",
          description_en_required: "English description is required",
          estimated_minutes_min: "At least 5 minutes"
        },
        equipment: {
      ...
      add_week_modal: {
        title: "Add a week",
        add_week_error: "Error adding week",
        title_fr_label: "Title (French)",
        title_fr_placeholder: "Week {number}",
        description_fr_label: "Description (French)",
        description_fr_placeholder: "Description of this week...",
        title_en_label: "Title",
        title_en_placeholder: "Week {number}",
        description_en_label: "Description",
        description_en_placeholder: "Week description...",
        cancel: "Cancel",
        add_week: "Add week",
        adding_week: "Adding...",
        validation: {
      ...
      create_program_modal: {
        ...
        steps: {
          ...
          configuration: {
            title: "Configuration",
            description: "Duration, frequency, equipment...",
          },
          coaches: {
            title: "Coaches",
            description: "Add coaches to the program",
          },
        },
      },
      create_program_form: {
        steps: {
          ...
          step_2_title: "Program Configuration",
          step_3_title: "Coaches",
        },
        tabs: {
          fr: "🇫🇷 FR",
          en: "🇺🇸 EN",
        ...
        labels: {
          ...
          coach_image_url: "Coach's image URL",
        },
        placeholders: {
          category: "e.g. Bodybuilding",
          image_url: "https://...",
          coach_name: "Coach's name...",
        },
        buttons: {
        ...
        validation: {
          ...
          duration_min: "At least 1 week",
          sessions_min: "At least 1 session per week",
          session_duration_min: "At least 5 minutes",
          coach_name_required: "The coach's name is required.",
          submission_error: "Please complete all required fields before submitting.",
        },
        success_message: "Program created successfully!",
        error_message: "Error creating the program",
      },
      delete_program_button: {
        title: "Confirm Deletion",
        confirmation_prefix: "Are you sure you want to delete the program",
        confirmation_suffix: "? This action is irreversible.",
        warning_message: "This will also delete all associated weeks, sessions, and exercises.",
        cancel_button: "Cancel",
        delete_button: "Delete",
        delete_button_loading: "Deleting...",
        error_message: "Error deleting the program.",
      },
      edit_program_modal: {
        title: "Edit Program",
        save_button: "Save",
        ...
        cancel_button: "Cancel",
        error_message: "Error saving the program.",
        tabs: {
          fr: "🇫🇷 FR",
          en: "🇺🇸 EN",
        },
        labels: {
          ...
          coach_image_url: "Coach Image URL",
        },
        placeholders: {
          coach_name: "Enter coach name",
          image_url: "https://...",
        },
        buttons: {
          add_coach: "Add Coach",
      ...
      edit_session_modal: {
        ...
        validation: {
          title_required: "Title is required",
          description_required: "Description is required",
          duration_too_short: "At least 5 minutes",
        },
        error_message: "Error updating session",
      },
      edit_sets_modal: {
        title: "Edit Sets - {exerciseName}",
        set_badge: "SET {setIndex}",
        placeholders: {
          min: "min",
          sec: "sec",
        },
        ...
        error_saving: "Error saving sets",
      },
      edit_week_modal: {
        ...
        error_saving: "Error saving week",
      },
      program_builder: {
        ...
        session_duration: "{count} min/session",
        sessions_per_week: "{count} sessions/week",
        equipment: "Equipment:",
        none: "None",
        coaches: "Coaches ({count})",
        edit_coaches: "Edit coaches",
        no_coaches_assigned: "No coaches assigned",
        no_coaches_description: "Add coaches to introduce the experts who will guide the users.",
        add_coach: "Add a coach",
        coach_order: "Coach #{order}",
        weeks: "Weeks ({count}/{total})",
        add_week: "Add a week",
        no_weeks_created: "No weeks created",
        no_weeks_description: "Start by adding the first week of your program.",
        add_first_week: "Add the first week",
        analytics_title: "Statistics",
        analytics_description: "Program analytics and metrics (to be implemented)",
      },
      programs_list: {
        no_programs_title: "No programs",
        no_programs_description: "Start by creating your first workout program.",
        table_header_program: "Program",
        ...
        sessions_per_week: "{count} sessions/wk",
        content_summary: "{weeks} wks • {sessions} sessions",
        total_exercises: "{count} exercises",
        view_program_tooltip: "View program",
        manage_program_tooltip: "Manage program",
      },
      session_card: {
        session_title: "Session {number}: {title}",
        premium: "Premium",
        free: "Free",
        estimated_time: "{count} min",
        exercise: "exercise",
        exercises: "exercises",
        edit_session_tooltip: "Edit session",
        add_exercise_button: "Exercise",
        no_exercises_title: "No exercises in this session",
        add_first_exercise_button: "Add the first exercise",
        set: "set",
        sets: "sets",
        edit_sets_tooltip: "Edit sets",
      },
      week_card: {
        week_title: "Week {number}: {title}",
        session: "session",
        sessions: "sessions",
        edit_week_tooltip: "Edit week",
        add_session_button: "Session",
        no_sessions_title: "No sessions in this week",
        add_first_session_button: "Add the first session",
      },
      visibility_badge: {
        draft: "Draft",
        published: "Published",
    ...
    settings: {
      title: "Settings",
      description: "Configuration and administration of the system.",
    },
    header: {
    ...
    users_table: {
      all_users: "All Users",
      search_placeholder: "Search by ID or email...",
      id: "ID",
      name: "Name",
      email: "Email",
      role: "Role",
      ...
      impersonation_error: "Impersonation Error",
      impersonation_error_message: "An error occurred.",
      impersonation_exception: "An exception occurred during impersonation.",
      loading_error: "Error loading users",
      loading_error_message: "Could not retrieve the list of users. Please try again later.",
      unknown_error: "Unknown error",
      no_data: "No data available or loading error.",
    ...
    sidebar: {
      ...
      dashboard: "Dashboard",
      dashboard_description: "Overview of the statistics.",
      users: "Users",
      users_description: "Manage users.",
      programs: "Programs",
      programs_description: "Manage programs.",
      settings: "Settings",
      settings_description: "Configuration of the system.",
      admin_footer: "WorkoutCool Admin",
      version: "Version",
    },
  },
  breadcrumbs: {
